void Graph_MC_eff(){
  ...
  gStyle->SetOptStat(0);
  TGraphErrors *gr5 = new TGraphErrors("Sigma_30.dat","%lg %*lg %*lg %lg");
 // gr5->SetMarkerStyle(24);
  // gr5->Draw("ap");
  gr5->GetYaxis()->SetTitle("Rad corection e^{+}e^{-}#rightarrow K_{s} K_{s} #pi^{+} #pi^{-}");
  ...
  TGraphErrors *gr6 = new TGraphErrors("Sigma_30.dat","%lg %lg %lg %*lg");
 ...
 // gr4->Draw("p same");
  //gr4->Draw("apl");
  TCanvas *c3 = new TCanvas("c3","Crossection");
  TGraphErrors *gr7 = new TGraphErrors("efficiency_mc_only_central_sqcorr.dat","%lg %lg %lg %*lg %*lg");
  	gr7->GetXaxis()->SetTitle("Enegry C.M, MeV");
	gr7->GetYaxis()->SetTitle("MC efficiency");
	gr7->GetXaxis()->SetTitleOffset(1.);
	gr7->GetXaxis()->SetTitleSize(0.05);
	gr7->GetYaxis()->SetTitleOffset(1.3);
	gr7->GetYaxis()->SetTitleSize(0.05);
	gr7->GetXaxis()->SetLabelSize(0.045);
	gr7->GetYaxis()->SetLabelSize(0.045);
	gr7->Draw("ap");
